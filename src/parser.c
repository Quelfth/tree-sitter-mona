...
enum ts_symbol_identifiers {
  ...
  sym__statement = 47,
  sym_field_item = 48,
  sym_variants_item = 49,
  sym__variants_paragraph = 50,
  sym_variant = 51,
  sym_function_item = 52,
  sym_simple_parameter = 53,
  sym_named_parameters = 54,
  sym_named_parameter = 55,
  sym__expr = 56,
  sym__argument_expr = 57,
  sym_parenthetical = 58,
  sym_object = 59,
  sym_field_expression = 60,
  sym_pre_unary_expression = 61,
  ...
  aux_sym__statement_paragraph_repeat1 = 69,
  aux_sym_variants_item_repeat1 = 70,
  aux_sym__variants_paragraph_repeat1 = 71,
  aux_sym_named_parameters_repeat1 = 72,
};
...
static const char * const ts_symbol_names[] = {
  ...
  [sym_variants_item] = "variants_item",
  [sym__variants_paragraph] = "_variants_paragraph",
  [sym_variant] = "variant",
  ...
  [aux_sym_variants_item_repeat1] = "variants_item_repeat1",
  [aux_sym__variants_paragraph_repeat1] = "_variants_paragraph_repeat1",
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [sym_variants_item] = sym_variants_item,
  [sym__variants_paragraph] = sym__variants_paragraph,
  ...
  [aux_sym_variants_item_repeat1] = aux_sym_variants_item_repeat1,
  [aux_sym__variants_paragraph_repeat1] = aux_sym__variants_paragraph_repeat1,
...
static const TSSymbolMetadata ts_symbol_metadata[] = {
  ...
  [aux_sym_variants_item_repeat1] = {
    .visible = false,
    .named = false,
  },
  [aux_sym__variants_paragraph_repeat1] = {
    .visible = false,
    .named = false,
  },
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    ...
    [sym__statement_paragraph] = STATE(107),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [81] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field_item, 6, 0, 13),
  ...
  [97] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pre_unary_expression, 2, 0, 0),
  [99] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_pre_unary_expression, 2, 0, 0),
  [101] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_binding, 2, 0, 3),
  [103] = {.entry = {.count = 1, .reusable = true}}, SHIFT(29),
  [105] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_variable_binding, 2, 0, 3),
  [107] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field_item, 3, 0, 5),
  ...
  [113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field_item, 4, 0, 9),
  [115] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field_item, 5, 0, 10),
  [117] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__statement, 1, 0, 0),
  ...
  [143] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_integer, 2, 0, 0),
  [145] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_integer, 2, 0, 0),
  ...
  [157] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_integer, 3, 0, 0),
  [159] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_integer, 3, 0, 0),
  [161] = {.entry = {.count = 1, .reusable = true}}, SHIFT(48),
  [163] = {.entry = {.count = 1, .reusable = false}}, SHIFT(20),
  [165] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_binding, 3, 0, 7),
  [167] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_variable_binding, 3, 0, 7),
  [169] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call_expression, 2, 0, 2),
  [171] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call_expression, 2, 0, 2),
  [173] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parenthetical, 4, 0, 0),
  [175] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_parenthetical, 4, 0, 0),
  [177] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object, 4, 0, 0),
  [179] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_object, 4, 0, 0),
  [181] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_integer, 4, 0, 0),
  [183] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_integer, 4, 0, 0),
  [185] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object, 5, 0, 0),
  [187] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_object, 5, 0, 0),
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object, 6, 0, 0),
  [191] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_object, 6, 0, 0),
  [193] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parenthetical, 6, 0, 0),
  [195] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_parenthetical, 6, 0, 0),
  [197] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field_expression, 3, 0, 6),
  [199] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_field_expression, 3, 0, 6),
  [201] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parenthetical, 5, 0, 0),
  [203] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_parenthetical, 5, 0, 0),
  [205] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field_item, 1, 0, 0),
  [207] = {.entry = {.count = 1, .reusable = true}}, SHIFT(121),
  [209] = {.entry = {.count = 1, .reusable = true}}, SHIFT(43),
  [211] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field_item, 2, 0, 1),
  [213] = {.entry = {.count = 1, .reusable = true}}, SHIFT(112),
  [215] = {.entry = {.count = 1, .reusable = true}}, SHIFT(36),
  [217] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field_item, 4, 0, 8),
  [219] = {.entry = {.count = 1, .reusable = true}}, SHIFT(41),
  [221] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variant, 1, 0, 3),
  [223] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__statement_paragraph, 2, 0, 0),
  [225] = {.entry = {.count = 1, .reusable = true}}, SHIFT(14),
  [227] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__statement_paragraph_repeat1, 2, 0, 0),
  [229] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__statement_paragraph_repeat1, 2, 0, 0), SHIFT_REPEAT(14),
  [232] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__statement_paragraph, 3, 0, 0),
  ...
  [239] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field_item, 3, 0, 4),
  ...
  [249] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variants_item, 4, 0, 0),
  [251] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_item, 11, 0, 17),
  ...
  [259] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variants_item, 5, 0, 0),
  [261] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variants_item, 6, 0, 0),
  [263] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_item, 6, 0, 14),
  [265] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_item, 7, 0, 14),
  [267] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_item, 7, 0, 15),
  [269] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_item, 8, 0, 16),
  [271] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_item, 8, 0, 14),
  [273] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_item, 8, 0, 15),
  [275] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_item, 9, 0, 16),
  [277] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_item, 9, 0, 17),
  [279] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_item, 9, 0, 15),
  [281] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_item, 10, 0, 16),
  [283] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_item, 10, 0, 17),
  [285] = {.entry = {.count = 1, .reusable = true}}, SHIFT(2),
  [287] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_variants_item_repeat1, 2, 0, 0),
  [289] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_variants_item_repeat1, 2, 0, 0), SHIFT_REPEAT(110),
  ...
  [308] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__variants_paragraph, 3, 0, 0),
  ...
  [322] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__variants_paragraph_repeat1, 2, 0, 0), SHIFT_REPEAT(93),
  [325] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__variants_paragraph_repeat1, 2, 0, 0),
  ...
  [351] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__variants_paragraph, 2, 0, 0),
  [353] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variant, 2, 0, 12),
  [355] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_named_parameters_repeat1, 2, 0, 0),
  [357] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_named_parameters_repeat1, 2, 0, 0), SHIFT_REPEAT(123),
  [360] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variant, 2, 0, 11),
  ...
  [368] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_named_parameter, 3, 0, 0),
  [370] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_named_parameters, 2, 0, 0),
  [372] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_named_parameters, 5, 0, 0),
  [374] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_named_parameters, 3, 0, 0),
  [376] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_simple_parameter, 2, 0, 0),
  [378] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_simple_parameter, 3, 0, 0),
  [380] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_named_parameters, 4, 0, 0),

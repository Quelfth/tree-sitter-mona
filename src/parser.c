...
enum ts_symbol_identifiers {
  ...
  anon_sym_0b = 29,
  anon_sym_0b2 = 30,
  aux_sym_integer_token5 = 31,
  anon_sym_0o = 32,
  anon_sym_0o2 = 33,
  aux_sym_integer_token6 = 34,
  anon_sym_0z = 35,
  anon_sym_0z2 = 36,
  aux_sym_integer_token7 = 37,
  sym__paragraph_feed = 38,
  sym__paragraph_continue = 39,
  sym__scope_start = 40,
  sym__scope_end = 41,
  sym_source_file = 42,
  sym__item_paragraph = 43,
  sym__statement = 44,
  sym_expression_statement = 45,
  sym__expr = 46,
  sym__argument_expr = 47,
  sym_parenthetical = 48,
  sym_object = 49,
  sym_field_expression = 50,
  sym_pre_unary_expression = 51,
  sym_binary_expression = 52,
  sym_call_expression = 53,
  sym_variable_binding = 54,
  sym__type = 55,
  sym_name = 56,
  sym_integer = 57,
  aux_sym_source_file_repeat1 = 58,
  aux_sym__item_paragraph_repeat1 = 59,
};
...
static const char * const ts_symbol_names[] = {
  ...
  [sym__item_paragraph] = "_item_paragraph",
  ...
  [aux_sym__item_paragraph_repeat1] = "_item_paragraph_repeat1",
};
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [sym__item_paragraph] = sym__item_paragraph,
  ...
  [aux_sym__item_paragraph_repeat1] = aux_sym__item_paragraph_repeat1,
};
...
static const TSSymbolMetadata ts_symbol_metadata[] = {
  ...
  [aux_sym__item_paragraph_repeat1] = {
    .visible = false,
    .named = false,
  },
};
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (set_contains(aux_sym_integer_token3_character_set_1, 685, lookahead)) ADVANCE(38);
      END_STATE();
    case 1:
      if (lookahead == ' ') SKIP(1);
    ...
    case 7:
      ...
      END_STATE();
    case 8:
      if (set_contains(sym_identifier_character_set_1, 684, lookahead)) ADVANCE(45);
      END_STATE();
    case 9:
      if (set_contains(sym_identifier_character_set_3, 800, lookahead)) ADVANCE(38);
      END_STATE();
    case 10:
      if (set_contains(sym_identifier_character_set_3, 800, lookahead)) ADVANCE(45);
      END_STATE();
    case 11:
      if (eof) ADVANCE(16);
      if (lookahead == ' ') SKIP(11);
    ...
    case 14:
      ...
      if (set_contains(aux_sym_integer_token3_character_set_1, 685, lookahead)) ADVANCE(45);
      END_STATE();
    case 15:
      if (eof) ADVANCE(16);
      if (lookahead == ' ') SKIP(15);
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [75] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pre_unary_expression, 2, 0, 0),
  [77] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_pre_unary_expression, 2, 0, 0),
  [79] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_binding, 2, 0, 2),
  [81] = {.entry = {.count = 1, .reusable = true}}, SHIFT(19),
  [83] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_variable_binding, 2, 0, 2),
  ...
  [91] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_integer, 1, 0, 0),
  [93] = {.entry = {.count = 1, .reusable = true}}, SHIFT(34),
  [95] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name, 1, 0, 0),
  [97] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name, 1, 0, 0),
  ...
  [105] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_integer, 2, 0, 0),
  [107] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_integer, 2, 0, 0),
  ...
  [119] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_integer, 3, 0, 0),
  [121] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_integer, 3, 0, 0),
  [123] = {.entry = {.count = 1, .reusable = true}}, SHIFT(36),
  [125] = {.entry = {.count = 1, .reusable = false}}, SHIFT(16),
  [127] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parenthetical, 4, 0, 0),
  [129] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_parenthetical, 4, 0, 0),
  [131] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object, 6, 0, 0),
  [133] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_object, 6, 0, 0),
  ...
  [139] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field_expression, 3, 0, 3),
  [141] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_field_expression, 3, 0, 3),
  [143] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_binding, 3, 0, 4),
  [145] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_variable_binding, 3, 0, 4),
  [147] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object, 4, 0, 0),
  [149] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_object, 4, 0, 0),
  [151] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_integer, 4, 0, 0),
  [153] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_integer, 4, 0, 0),
  [155] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parenthetical, 5, 0, 0),
  [157] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_parenthetical, 5, 0, 0),
  [159] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object, 5, 0, 0),
  [161] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_object, 5, 0, 0),
  [163] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parenthetical, 6, 0, 0),
  [165] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_parenthetical, 6, 0, 0),
  [167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__item_paragraph, 3, 0, 0),
  [169] = {.entry = {.count = 1, .reusable = true}}, SHIFT(10),
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__item_paragraph_repeat1, 2, 0, 0),
  [173] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__item_paragraph_repeat1, 2, 0, 0), SHIFT_REPEAT(10),
  [176] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__item_paragraph, 2, 0, 0),
  [178] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0),
  [180] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(7),
